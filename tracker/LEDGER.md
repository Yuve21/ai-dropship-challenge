...
product tests, decisions, P&L. A new seat reads this first (after the playbook) to know exactly where
things stand. Log what ACTUALLY happened, never a projection. Mark estimates vs dashboard-confirmed.
